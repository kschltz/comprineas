...
- Location: tests/items.spec.js:91:3
...
Locator: locator('#add-item-error')
...
Call log:
  ...
  - waiting for locator('#add-item-error')
    14 × locator resolved to <div id="add-item-error" class="text-red-600 text-sm mb-2 hidden"></div>
       - unexpected value ""
    ...
    - generic [ref=e11]:
      - generic [ref=e13]:
        ...
        - generic [ref=e17]:
          ...
          - button "8RHYVE" [ref=e19] [cursor=pointer]
      - generic [ref=e20]:
