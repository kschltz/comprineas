...
- Location: tests/realtime.spec.js:103:3
...
Locator: locator('div.opacity-50').filter({ hasText: 'Bananas' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.opacity-50').filter({ hasText: 'Bananas' })
    ...
    - generic [ref=e11]:
      - generic [ref=e13]:
        ...
        - generic [ref=e17]:
          ...
          - button "Y9WEOL" [ref=e19] [cursor=pointer]
      - generic [ref=e20]:
