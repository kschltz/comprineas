...
Locator: div.opacity-50:has(text=Bananas)
Expected: visible
Error: Unexpected token "=" while parsing css selector "div.opacity-50:has(text=Bananas)". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for div.opacity-50:has(text=Bananas)
    ...
    - generic [ref=e11]:
      - generic [ref=e13]:
        ...
        - generic [ref=e17]:
          ...
          - button "KEQ068" [ref=e19] [cursor=pointer]
      - generic [ref=e20]:
